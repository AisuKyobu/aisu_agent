...
<template>
  <div class="app-header">
    <div style="display:flex;align-items:center;gap:10px">
      <span class="app-logo" title="返回首页" @click="authPage = ''"><LogoIcon :size="18" />Aisu</span>
  ...
  <div v-if="authPage" class="auth-back-bar">
    <button type="button" class="page-back-btn" @click="authPage = ''">← 返回</button>
  </div>
